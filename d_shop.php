			...
			<div class="row">
								...
								<div class="content">
									<div class="shop_single_product_details">
										...
										<ul class="sspd_sku mb30">
											<li><a href="#">SKU: woo-album Category: Music</a></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-4">
					...
					<div class="sidebar_recent_product">
						<h4 class="title">Recent Products</h4>
						<div class="media">
							<img class="align-self-start mr-3" src="images/shop/ss1.png" alt="ss1.png">
							<div class="media-body">
						    	<h5 class="mt-0 post_title">Album</h5>
						    	<a href="#">$13,000</a>
							</div>
						</div>
						<div class="media">
							<img class="align-self-start mr-3" src="images/shop/ss2.png" alt="ss2.jpg">
							<div class="media-body">
						    	<h5 class="mt-0 post_title">Beanie</h5>
						    	<a href="#">$13,000</a>
							</div>
						</div>
						<div class="media">
							<img class="align-self-start mr-3" src="images/shop/ss3.png" alt="ss3.jpg">
							<div class="media-body">
						    	<h5 class="mt-0 post_title">T-Shirt</h5>
						    	<a href="#">$13,000</a>
							</div>
						</div>
					</div>
