        ...
        <div class="row mb30">
            <div class="col-lg-7 col-xl-8">
                <div class="single_property_title mt30-767">
                    <h2 class="text-thm" style="text-align: right;">مضخة مياة</h2>
                    
                                    
                <p  style="text-align: right;"> رقم الموديل: m15 </p>
            

                <p style="text-align: right;"><span class="flaticon-placeholder"></span> السعودية-الدمام</p>

                <p  style="text-align: right;"> السعر: 1000 ريال </p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="spls_style_two mb30-520">
                            <a class="popup-img" href="images/property/fp1.jpg"><img class="img-fluid w100" src="images/property/fp1.jpg" alt="1.jpg"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-6">
                        <div class="spls_style_two mb30">
                            <a class="popup-img" href="images/property/fp1.jpg"><img class="img-fluid w100" src="images/property/fp1.jpg" alt="2.jpg"></a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-6">
                        <div class="spls_style_two mb30">
                            <a class="popup-img" href="images/property/fp1.jpg"><img class="img-fluid w100" src="images/property/fp1.jpg" alt="3.jpg"></a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-6">
                        <div class="spls_style_two mb30">
                            <a class="popup-img" href="images/property/fp1.jpg"><img class="img-fluid w100" src="images/property/fp1.jpg" alt="4.jpg"></a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-6">
                        <div class="spls_style_two mb30">
                            <a class="popup-img" href="images/property/fp1.jpg"><img class="img-fluid w100" src="images/property/fp1.jpg" alt="5.jpg"></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="property_attachment_area">
                            <h4 class="mb30">مرفقات المنتج</h4>
