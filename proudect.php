				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="feat_property list style2 agent">
								<div class="thumb">
									<img class="img-whp" src="images/team/12.jpg" alt="12.jpg">
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item dn"></li>
											<li class="list-inline-item"><a href="#">2 Listings</a></li>
						...
						<div class="col-lg-12">
							<div class="feat_property list style2 agent">
								<div class="thumb">
									<img class="img-whp" src="images/team/13.jpg" alt="13.jpg">
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item dn"></li>
											<li class="list-inline-item"><a href="#">2 Listings</a></li>
						...
						<div class="col-lg-12">
							<div class="feat_property list style2 agent">
								<div class="thumb">
									<img class="img-whp" src="images/team/16.jpg" alt="16.jpg">
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item dn"></li>
											<li class="list-inline-item"><a href="#">2 Listings</a></li>
