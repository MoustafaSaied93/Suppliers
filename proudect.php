...
<section class="our-listing bgc-f7 pb30-991">
		<div class="container">
						...
						<div class="sidebar_content_details style3">
							...
							<div class="sidebar_listing_list style2 mobile_sytle_sidebar mb0">
								<div class="sidebar_advanced_search_widget">
									<h4 class="mb25">بحث متقدم <a class="filter_closed_btn float-right" href="#"><small>اخفاء الفلترة</small> <span class="flaticon-close"></span></a></h4>
											    ...
											    <div class="panel">
											      	<div class="panel-heading">
												      	<h4 class="panel-title">
												        	<a href="#panelBodyRating" class="accordion-toggle link" data-toggle="collapse" data-parent="#accordion"><i class="flaticon-more"></i> فلترة متقدمة</a>
												        </h4>
											      	</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="breadcrumb_content style2 mb0-991" style="text-align: right;">
						<ol class="breadcrumb">
						    <li class="breadcrumb-item"><a href="#">الريئسية</a></li>
						    <li class="breadcrumb-item active text-thm" aria-current="page">قائمة المنتجات</li>
						</ol>
						<h2 class="breadcrumb_title">قائمة المنتجات</h2>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="listing_list_style mb20-xsd tal-991">
						<ul class="mb0" style="float: left;">
									...
									<div class="feat_property home7">
										<div class="thumb">
											...
											<div class="thmb_cntnt">
												...
												<a class="fp_price" href="#">10،000<small>الف ريال</small></a>
												<h4 class="posr color-white">قطع غيار</h4>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="grid_list_search_result">
							<div class="col-sm-12 col-md-4 col-lg-4 col-xl-5">
								<div class="left_area tac-xsd">
									<p  style=" text-align: right; font-family:rb;"> عدد الاقاسام :9</p>
								</div>
							</div>
								...
								<div class="details">
									<div class="tc_content">
										<div class="dtls_headr">
											<ul class="tag">
												<li class="list-inline-item"><a href="#">للتسوق</a></li>
												<li class="list-inline-item"><a href="#">متوفر : ٥ قطع</a></li>
											</ul>
										</div>
										<h4>قسم قطع الغيار</h4>
