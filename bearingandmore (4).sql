...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2021 at 07:08 AM
...
(54, 'Rady elshimery', '123456789', 'Radhi00999@gmail.com', '00923045900', '123123n787', '', '1', 'الرياض', '123 jaddah', '', '1', '', '07/15/2021', 'Files/STI-6200-Installation-Instructions (2).pdf', '2021-07-21', '105', 'المتحده', '', '', '', '', '', '', '', '', '', '', '0', '');
...
(14, 'معدات ونظم الاغلاق الهوائية الصناعية', ''),
(15, 'معدات وادوات كهربائية صناعية', ''),
(16, 'معدات وادوات نظم التحليل الصناعية', '');
...
(40, 8, 'معدات ثابتة', 'المضخات الصناعية', 54, 'مضخه مياه', 'العلامة التجارية : توتال تولز\r\nمصدر الطاقة : بنزين\r\nالنوع : مضخات المياه\r\nرقم الموديل : TP3202\r\nهل يتطلب هذا المنتج بطارية او يحتوي بطارية : لا\r\nهل هذا المنتج خطير أو يحتوي على مواد خطرة، سامة أو نفايات خاضعة لأنظمة تتعلق بالنقل، التخزين وأو التخلص منها؟ :', 'TP3202', '', ' 50', 'japan', 'المتحده', '561B-data (1) (1) (1).pdf', 1, 'item_XXL_132733006_fe3212628baa4.jpg', '', '', '', '', 0, '', '', 'null', 'MM', '', '', '', '', '', '', '', '20فولت', '2021-08-21', '1', ''),
(41, 8, 'معدات ثابتة', 'المضخات الصناعية', 54, 'مضخة رفع المياه', 'رقم الموديل : JPC 4-54\r\nالنوع : مضخات المياه\r\nمصدر الطاقة : سلك كهرباء\r\nالعلامة التجارية : غرندفوس\r\nلا حاجة لإعادة تعبئة المضخة بالمياه و تنفيس الهواء (تحضير ذاتي)\r\nمُصنعة من التكنوبوليمر الغير قابل للصدأ\r\nموتور محكم الغلق للحماية من مياه الأمطار و الغبار بدرجة حماية IP44\r\nتعمل بكفاءة في درجات حرارة الجو المرتفعة حتى 55 درجة مئوية\r\nاستهلاك منخفض للكهرباء\r\nسهلة التركيب', 'JPC 4-54', '', ' ', '', 'المتحده', '3-hp-solar-openwell-pump (2) (1) (2).pdf', 1, 'item_XXL_37775001_147134659.jpg', '', '', '', '', 0, '', '', 'null', 'MM', '', '', '', '', '', '', '', '', '2021-08-21', '1', ''),
(42, 8, 'معدات متحركة ', 'انابيب صناعية', 54, 'انبوب بولي ايثيلين للري', 'انبوب بولي ايثيلين للري', '13Pcs', '', ' ', '', 'المتحده', '3-hp-solar-openwell-pump (2) (1) (1).pdf', 1, 'item_XXL_23149025_32729840.jpg', '', '', '', '', 0, '', '', 'بلاستيك', 'MM', '', '', '', '', '', '', '', '', '2021-08-21', '1', ''),
...
(60, 16, 'ادوات نظم التحليل الصناعى', '', 54, 'انليزر ESA615', 'يقدم محلل السلامة الكهربائية ESA615 اختبارًا آليًا سريعًا وبسيطًا في شكل محلل محمول لمتخصصي تكنولوجيا الرعاية الصحية الذين يقومون بإجراء اختبار السلامة الكهربائية على المعدات الطبية في الميدان وفي المرافق. سواء كان اختبارًا ', 'ESA615', '', ' 30', 'الصين', 'المتحده', '1470717463.pdf', 1, 'fb-esa615-us_01a_s.png', '', '', '', '', 0, '', '', 'null', 'ANSH', '', ' 2.75', '1.55', '', '', '', '', '240 ', '2021-08-22', '2', '20000');
...
--
ALTER TABLE `accounts`
  MODIFY `UserID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `clintmessages`
  MODIFY `MessageID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `notfication`
--
ALTER TABLE `notfication`
  MODIFY `NotID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
