...
$query = mysqli_query($conn, "SELECT * FROM product WHERE Refused=1");
  ...
  <div class="row gutters">
    ...
    <table id="copy-print-csv" class="table custom-table">
     ...
     accounts a
          ...
          categories c
          ON p.cat_id = c.cat_id WHERE  p.Refused='1' AND p.Accept='0'");
     $num=1;
     ...
     <button type="button" data-toggle="modal" data-target="#DeleteConfirmationsss" onclick="DeleteProduct(<?php echo $row['product_id']; ?>)" class="btn btn-danger"> حذف المنتج</button>
